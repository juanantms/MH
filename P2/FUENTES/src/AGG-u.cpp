...
void AGGUniforme(vector<vector<bool>> &poblacion, int n, int m, double **M) {
...
int main()  {
    ...
    cout << "AGG-uniforme\t" << dispersion << endl;
    cout << "Tiempo_AGG-u\t" << tiempo.count() << endl;
